...
import MOVContainer from "./MOVContainer";
			...
			>
				<div className={classes.paper}>
					...
					>
						...
						<Grid item>
							<IMGContainer url={store.getState().pk.sprites} />
						</Grid>
						...
						<Grid container spacing={2} direction="row" justify="space-around">
							<MOVContainer moves={store.getState().pk.moves} />
							<TypeContainer types={store.getState().pk.types} />
						</Grid>
					</Grid>
				</div>
			</Modal>
